...
class NN1_BN_FaceNet_4K(nn.Module):
    ...
    def __init__(self, classify=False, embedding_size = 128, device=None):
        ...
        self.fc2 = nn.Sequential(nn.Linear(32*128, embedding_size))
...
class NN1_BN_FaceNet_2K(nn.Module):
    ...
    def __init__(self, classify=False, embedding_size = 128, device=None):
        ...
        self.fc2 = nn.Sequential(nn.Linear(2048, embedding_size))
...
class NN1_BN_FaceNet_1K(nn.Module):
    ...
    def __init__(self, classify=False, embedding_size = 128, device=None):
        ...
        self.fc2 = nn.Sequential(nn.Linear(1024, embedding_size))
...
class NN1_BN_FaceNet_05K(nn.Module):
    ...
    def __init__(self, classify=False, embedding_size = 128, device=None):
        ...
        self.fc2 = nn.Sequential(nn.Linear(4*128, embedding_size))
